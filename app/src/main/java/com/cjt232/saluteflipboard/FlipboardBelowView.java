...
public class FlipboardBelowView extends View {
    ...
    public FlipboardBelowView(Context context) {
        this(context, null);
    }

    public FlipboardBelowView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlipboardBelowView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        rect = new Rect(0, centerY, getWidth(), getHeight());
    }
